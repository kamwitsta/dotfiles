...
-- Remember that these are applied *after* the standard normalization, so the substitution must be decomposed as much as possible, as in ë́ → e\776\769 rather than ë\769.
